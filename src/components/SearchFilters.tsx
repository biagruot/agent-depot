...
export function SearchFilters({
  ...
  const getAvailableTypes = (): { id: AgentType | "all"; label: string; icon: string }[] => {
    ...
    if (selectedTool === "replit") {
      return [...baseTypes, { id: "template", label: "Frameworks", icon: "📦" }];
    }
  ...
  return (
    <div className="space-y-6">
      ...
      <SearchAutocomplete searchQuery={searchQuery} setSearchQuery={setSearchQuery} />
      ...
      <div className="flex overflow-x-auto pb-2 md:pb-0 md:flex-wrap md:justify-center gap-2 no-scrollbar">
        <button
          ...
          className={`px-4 py-1.5 rounded-full text-sm font-medium transition-all duration-300 whitespace-nowrap flex items-center gap-2 ${
            selectedTool === "all"

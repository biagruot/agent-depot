        ...
        <div className="min-h-screen flex items-center justify-center px-4">
            <div className="text-center space-y-8 max-w-2xl">
                ...
                <div className="absolute -top-20 left-1/2 -translate-x-1/2 w-[600px] h-[300px] opacity-20 pointer-events-none blur-[100px]">
                    <div className="absolute top-0 left-0 w-1/2 h-full bg-red-500/40 rounded-full mix-blend-screen animate-pulse" style={{ animationDuration: '2s' }} />
                    <div className="absolute top-0 right-0 w-1/2 h-full bg-orange-500/40 rounded-full mix-blend-screen animate-pulse" style={{ animationDuration: '3s', animationDelay: '0.5s' }} />
                </div>

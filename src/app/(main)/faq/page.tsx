...
export const metadata: Metadata = {
  ...
  description:
    "Get answers to common questions about Cursor Rules, Windsurf Cascade, Claude Plugins & Skills, Replit Templates, and MCP Servers. Learn how to install and create custom AI tools.",
  keywords: [
  ...
  openGraph: {
    title: "FAQ - Frequently Asked Questions",
    description:
      "Complete guide to Cursor Rules, Claude Plugins, Replit Templates, and MCP Servers.",
    type: "website",
  },
};
...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "Windsurf Cascade is an AI flow state that maintains context across your entire project. Unlike standard chat, Cascade understands your file structure and can perform complex, multi-step refactoring. You can install Windsurf-specific flows or prompts from AgentDepot to optimize Cascade for tasks like debugging or feature implementation.",
  },
  {
    category: "Getting Started",
    question: "Are the resources on AgentDepot free?",
    answer:
      "Yes, most content on AgentDepot—including Cursor Rules, Replit Templates, and MCP Servers—is free and open-source. However, using the underlying AI models (like GPT-4 or Claude 3.5) within these tools usually requires a subscription to the respective platform (Cursor Pro, Windsurf, or Claude Pro). We clearly indicate if a specific tool requires a paid API key or subscription.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Claude Plugins (often used with Claude Code CLI) and Skills allow the AI to perform actions beyond text generation, like running terminal commands, querying databases, or managing files. They turn Claude from a chatbot into a capable coding assistant. AgentDepot lists popular plugins for testing, database management, and code review.",
  },
  {
    category: "Platform Comparison",
    question: "What are MCP Servers?",
    answer:
      "The Model Context Protocol (MCP) connects AI assistants to your data. An 'MCP Server' is a bridge that lets tools like Claude Desktop talk to external systems like GitHub, Slack, or PostgreSQL. Installing an MCP Server gives your AI direct access to those resources.",
  },
  {
    category: "Installation & Setup",
    question: "How do I install a Replit Template?",
    answer:
      "Replit Templates are full development environments. On AgentDepot, find a template (e.g., 'Python Flask Starter') and click the link to open it in Replit. You can then 'Fork' the template to create your own copy with all dependencies pre-installed.",
  },
  {
    category: "Installation & Setup",
    question: "Can I use multiple Rules or Plugins at once?",
    answer:
      "Yes! You can combine multiple Cursor Rules (e.g., one for TypeScript and one for testing). Similarly, you can enable multiple Claude Plugins or MCP Servers. Just ensure they don't have conflicting instructions—start with a focused set and expand as needed (e.g., a linter rule and a documentation plugin).",
  },
  {
    category: "Creating & Contributing",
    question: "How do I create a custom Cursor Rule?",
    answer:
      "Simply create a `.cursorrules` file in the root of your project. Write detailed instructions in plain English (e.g., 'Always use a specific naming convention', 'Prefer functional components'). You can refer to examples on AgentDepot for structure and formatting tips.",
  },
  {
    category: "Creating & Contributing",
    question: "How can I share my tools on AgentDepot?",
    answer:
      "We welcome contributions! Whether you've written a great Cursor Rule, built a Replit Template, or developed an MCP Server, you can submit it via our 'Submit' page. We review every submission to make sure it's safe and useful, and tools must be free to use. A public repository and clear documentation help your submission get approved faster.",
  },
  {
    category: "Use Cases & Best Practices",
    question: "Best automated workflows for beginners?",
    answer:
      "For **Cursor**, try the 'React Expert' rule to help with frontend code. For **Replit**, grab a 'Node.js Starter' template. For **Claude**, the 'Code Explainer' plugin is great for learning. Start small—installing too many extensions at once can be overwhelming.",
  },
  {
    category: "Technical Questions",
    question: "Do these tools work offline?",
    answer:
      "Most AI features (Cursor's generation, Claude's answers) require internet access to reach the LLMs. However, local rules and linting configurations work offline. Some local LLMs (via tools like Ollama) can be connected to these platforms for offline use if supported. AgentDepot tags agents that support offline functionality.",
  },
  {
    category: "Technical Questions",
    question: "How do I update an MCP Server or Plugin?",
    answer:
      "Updates depend on the installation method. For npm-based tools, run `npm update -g <package-name>`. For Cursor Rules, you simply update the text in your `.cursorrules` file. AgentDepot lists version information so you can check if a newer version of a tool is available.",
  },
  {
          ...
          <div className="text-center mb-12 space-y-6">
            ...
            <div className="space-y-3 relative z-10">
              ...
              <p className="text-lg md:text-xl text-gray-400 font-light tracking-wide max-w-2xl mx-auto">
                Everything you need to know about Cursor Rules, Windsurf Cascade, Claude Plugins &
                Skills, Replit Templates, and MCP Servers.
              </p>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-20 p-8 glass-panel rounded-3xl border border-white/10 bg-gradient-to-br from-blue-500/5 to-purple-500/5 text-center">
          ...
          <p className="text-gray-400 mb-6 max-w-xl mx-auto">
            Can&apos;t find what you&apos;re looking for? Browse our full directory of 70+ curated
            rules, plugins, and templates or submit your question.
          </p>

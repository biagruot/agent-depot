                ...
                <div className="prose prose-invert max-w-none space-y-8">
                    <section className="glass-panel rounded-3xl p-8">
                        ...
                        <p className="text-gray-300 leading-relaxed">
                            This Cookie Policy explains how AgentDepot (&quot;we&quot;, &quot;our&quot;, or &quot;us&quot;) uses cookies and
                            similar technologies when you visit agentdepot.dev (the &quot;Site&quot;).
                        </p>
                    ...
                    <section className="glass-panel rounded-3xl p-8">
                        ...
                        <p className="text-gray-300 leading-relaxed mb-4">
                            These cookies are necessary for the Site to function properly. They enable core features such as:
                        </p>
                    ...
                    <section className="glass-panel rounded-3xl p-8">
                        ...
                        <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
                            <li><strong>GitHub:</strong> When you visit GitHub links from our Site</li>
                            <li><strong>OpenPanel:</strong> For privacy-focused analytics tracking</li>
                        </ul>
                        <p className="text-gray-300 leading-relaxed mt-4">
                    ...
                    <section className="glass-panel rounded-3xl p-8">
                        ...
                        <p className="text-gray-300 leading-relaxed">
                            You can disable cookies entirely through your browser settings. Please note that disabling
                            cookies may affect the functionality of our Site and your ability to use certain features.
                        </p>
                    </section>

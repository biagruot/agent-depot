/* eslint-disable @next/next/no-head-element -- standalone email HTML document, not a Next.js page */
                            ...
                            <tr>
                              <td style={{ paddingBottom: "24px" }}>
                                ...
                                >
                                  ...
                                  who get the best AI coding agents delivered straight to their
                                  inbox.
                                </p>
                              </td>
                            </tr>
                                ...
                                >
                                  <li>
                                    <strong style={{ color: "#FFFFFF" }}>
                                      Weekly curated agents
                                    </strong>{" "}
                                    - Hand-picked rules and templates
                                  </li>
                                  <li>
                                    <strong style={{ color: "#FFFFFF" }}>New tool updates</strong> -
                                    Cursor, Windsurf, Claude Code & more
                                  </li>
                                  <li>
                                    <strong style={{ color: "#FFFFFF" }}>Pro tips</strong> - Level
                                    up your AI-assisted coding
                                  </li>
                                  <li>
                                    <strong style={{ color: "#FFFFFF" }}>No spam</strong> - Just
                                    high-signal content
                                  </li>
                                </ul>
                              </td>
                            ...
                            <tr>
                              <td align="center">
                                ...
                                <div style={{ textAlign: "center" }}>
                                  {["Cursor", "Windsurf", "Claude Code", "Replit", "MCP"].map(
                                    (tool) => (
                                      <span
                                        key={tool}
                                        style={{
